...
def bot():
    try:
        ...
        campo_de_texto = driver.find_element_by_xpath('//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[1]/div')
        campo_de_texto.click()
        resposta = requests.get("http://localhost/projeto/index.php", params={'msg': {msg},'telefone':{telefone_final}})
